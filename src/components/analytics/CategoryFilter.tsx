...
import { getCategoryClassName } from '@/lib/constants/categories';
                        ...
                        <div key={cat.value} className="relative">
                            <button
                                ...
                                className={`
                                    ...
                                    ${isSelected
                                        ? getCategoryClassName(cat.value)
                                        : 'border-2 border-border/50 bg-background hover:bg-muted transition-all'
                                    }
                                `}
                            >
                                {cat.label}
